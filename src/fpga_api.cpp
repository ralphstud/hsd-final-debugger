  ...
  for(int i = 0; i < num_output; i += SIZE)
  {
    ...
    {			
      for(int k = 0; k < num_matrix2; k += SIZE)
      {
        ...
        { 
          for(int c_1 = 0; c_1 < block_col_1; ++c_1)
            m1[r * SIZE + c_1] = weight_mat[(i + r) * num_input + j + c_1];
        }
        ...
        for(int c_1 = 0; c_1 < block_col_1; ++c_1)
        { 
          for(int c_2 = 0; c_2 < block_col_2; ++c_2)
            m2[c_1 * SIZE + c_2] = input_mat[(j + c_1) * num_matrix2 + k + c_2];
        }
